...
window.onload = function() {
  ...
  function generateCard() {
    ...
    let cardsPalos = document.querySelectorAll(".palo");
    ...
    cardsPalos.forEach(palo => {
      switch (randomPalo) {
        case "♥":
          palo.className = "heart palo";
          break;

        case "♦":
          palo.className = "diamond palo";
          break;

        case "♠":
          palo.className = "spade palo";
          break;

        case "♣":
          palo.className = "club palo";
          break;
      }
